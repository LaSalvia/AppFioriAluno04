		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title aluno04",
									"targetURL": "#AppFiorialuno04appfiorialuno04-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AppFiorialuno04appfiorialuno04-display": {
								"semanticObject": "AppFiorialuno04appfiorialuno04",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=AppFiorialuno04.appfiorialuno04",
									"url": sap.ui.require.toUrl("AppFiorialuno04/appfiorialuno04")
								}
							}
						}
					}
